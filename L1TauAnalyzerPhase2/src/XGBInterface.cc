// git clone 20200220
#include "L1TauAnalyzerPhase2/L1TauAnalyzerPhase2/interface/XGBInterface.h"
...
#include "L1TauAnalyzerPhase2/L1TauAnalyzerPhase2/interface/MVAInputVarTransformer.h" // MVAInputVarTransformer 
  ...
  , fitFunctionFileName_("")
{
  ...
  const std::string applicationLoadPath = (
    ...
    boost::filesystem::path("src/L1TauAnalyzerPhase2/L1TauAnalyzerPhase2/python/xgb/applicationLoad.py")
  ).string();
