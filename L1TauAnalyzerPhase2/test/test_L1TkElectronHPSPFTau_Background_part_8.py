...
process.L1TkElectronHPSPFTauAnalyzer.histRootFileName = cms.string("hist_test_L1TkElectronHPSPFTauAnalyzer_Background_20200803_part_8.root")
process.L1TkElectronHPSPFTauAnalyzer.bdtRootFileName = cms.string("bdt_test_L1TkElectronHPSPFTauAnalyzer_Background_20200803_part_8.root")
process.p = cms.Path(
	process.AnalyzerSeq
)
process.schedule = cms.Schedule(process.p)
process.TFileService=cms.Service('TFileService',fileName=cms.string("rootTree_test_L1TkElectronHPSPFTauAnalyzer_Background_20200803_part_8.root"))
